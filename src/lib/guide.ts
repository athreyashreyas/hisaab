...
export const GUIDE: GuideSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Your version and the device you are on ride along with the message, so you can describe what you saw and leave the rest. Your ledger stays out of it entirely, down to the last rupee.',
      'Everything gets read. Bugs are looked at quickly, ideas get proper thought, and an answer comes to the email you signed up with whenever there is one worth sending.',
      'Writing it offline works fine. The message sits on your device and goes out by itself once you have a connection, so you can close the app and forget about it.',
    ],
    steps: [
