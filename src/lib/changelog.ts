...
export const CHANGELOG: Release[] = [
  {
    ...
    date: '2026-08-17',
    major: true,
    title: 'Tell us what Hisaab should be',
    notes: [
      'Whatever is good about Hisaab is good because people took the time to say what was not working. Settings now has a direct line to the person who writes it, so that can keep happening.',
      ...
      'Your ledger stays out of it. The message carries your version number and the kind of device you are on, so you never have to describe the screen, and no amount or account name goes anywhere near it.',
      'Offline, or the message could not get through? It waits on your device and sends itself once you are back. Write it and forget about it.',
      'Replies arrive at the email you signed up with, so there is nothing to go and check. Answer that mail and the conversation carries on.',
    ],
    howTo: [
      'Open Settings, find "Make Hisaab Yours", and pick whether it is a bug or an idea.',
    ],
    art: 'message',
  },
  {
